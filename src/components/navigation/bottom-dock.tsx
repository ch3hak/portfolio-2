...
const dockData = {
  ...
  contact: {
    social: {
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://linkedin.com/in/chehaksharma",
        icon: Icons.linkedin,
      },
      X: {
        name: "X",
        url: "https://x.com/chehakksharma",
        icon: Icons.x,
      },
      // Hashnode: {
      //   name: "Hashnode",
...
const BottomDock = () => {
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-30 mx-auto mb-4 flex origin-bottom h-full max-h-14">
      <Dock className="z-50 pointer-events-auto relative mx-auto flex min-h-full h-full items-center px-1 bg-[#141415]/50 backdrop-blur-md">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  ...
                  className={cn(
                    buttonVariants({ variant: "ghost", size: "icon" }),
                    "size-10 hover:bg-transparent hover:text-[#EEEEEE] transition-all duration-200"
                  )}
                >
